...
<!--  플랫폼 값 https://localhost:8080 -->
   <script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=26e7c1ed90115e6227c7aa75d3b9592d&libraries=clusterer"></script>
  <script>
  ...
  const lng = 127.3776511;
    ...
    // 서버에서 가져오기 (관광공사 API)
    const  url = 'https://apis.data.go.kr/B551011/GoCamping/basedList?numOfRows=20&pageNo=1&MobileOS=ETC&MobileApp=testAPP&serviceKey=HlkkfCPrQ8k0NTwqeg3zU7a0A6pPYXq%2FVn4YAED70eh1QoEjqZpGuy3Wbx8ihzA%2F4xL%2BBTbic%2BwQfX4pMiJM1w%3D%3D&_type=json';
